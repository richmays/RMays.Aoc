...
1520";
        #endregion
        #region Day2
        public const string Day2 = @"1-9 x: xwjgxtmrzxzmkx
4-6 r: rrrkrgr
4-5 v: vvfvvvn
...
....###.....##.##....#.##.....#";
        #endregion
        #region Day4
        public const string Day4 = @"eyr:2028 iyr:2016 byr:1995 ecl:oth
...
hcl:#602927 iyr:2013 byr:2003 eyr:2023 cid:100";
        #endregion
        #region Day5
        public const string Day5 = @"BBFFBFFRRR
FBBFFBBLRR
FFBFBFBRRR
FFFBFBFRRR
BBFFBBFLRR
...
wozap";
        #endregion
        #region Day7
        public const string Day7 = @"plaid fuchsia bags contain 5 light violet bags, 1 light yellow bag.
...
bright lavender bags contain 4 striped blue bags.";
        #endregion
        #region Day8
        public const string Day8 = @"jmp +336
jmp +593
jmp +121
acc -8
nop +459
...
35";
        #endregion
        #region Day11
        public const string Day11 = @"LLLLL.LLLLLLLLLLLLLLLLLLLLLLLLLL.LLLLLLL.LLLLLLLLLL.LLLLLLLLLLL.LLLLLLLLLLLLLL.LLLL.LLLL.LLLLLL
...
F20";
        #endregion
        #region Day13
        public const string Day13 = @"1000299
41,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,37,x,x,x,x,x,971,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,17,13,x,x,x,x,23,x,x,x,x,x,29,x,487,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,19";
        #endregion
        #region Day14
        public const string Day14 = @"mask = X00000000000110011100XXX011110111011
mem[41579] = 225076
mem[14806] = 26208185
mem[47659] = 176531392
mem[27723] = 186971157
...
....#..#";
        #endregion
        #region Day18
        public const string Day18 = @"9 + (9 * 5 + 8 * 8 + 6) * 8
...
2 + (9 + 8 * 9 + 9 + 8 * (8 * 9 * 3 * 6 * 5)) + 6 + 3 * 6";
        #endregion
        #region Day19
        public const string Day19 = @"104: 114 114
13: 114 77 | 29 105
100: 20 114 | 111 29
80: 98 29 | 102 114
81: 29 10 | 114 89
...
abbbaababbbababaaababbbbbabababbbbaabbabbbbbbbaabbbbbaba";
        #endregion
        #region Day0
        public const string Day20 = @"Tile 2011:
.##...#..#
.#.#.#...#
.......###
.....##.#.
