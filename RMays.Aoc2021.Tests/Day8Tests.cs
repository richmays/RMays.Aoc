...
namespace RMays.Aoc2021.Tests
{
    ...
    public class Day8Tests
    {
        ...
        private string knownOutputA = "383";
        private string knownOutputB = "998900";
        ...
        [Test]
        [TestCase(@"acedgfb cdfbe gcdfa fbcad dab cefabd cdfgeb eafb cagedb ab | cdfeb fcadb cdfeb cdbaf", 0)]
        [TestCase(@"be cfbegad cbdgef fgaecd cgeb fdcge agebfd fecdb fabcd edb | fdgacbe cefdb cefbgd gcbe
